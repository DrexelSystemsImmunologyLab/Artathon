...
###save collapsed sequences dataframe
clone_509919_collapsed.to_pickle("path to save result clone_509919_collapsed.pkl")

###save clones table dataframe
clones_table.to_pickle("path to save result clones_table.pkl")
